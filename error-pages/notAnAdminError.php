    ...
    <body>
        <div class='container'>
            <div class='top-container'>
                ...
                <div class='text'>
                    <p>You are currently not logged in as an Admin </p>
                </div>
            </div>

            <div class='bottom-container'>
                Click <a href='#'>here</a> to login or You'll be automatically redirected to Home page in <span id='countdowntimer'>5</span> seconds.
            </div>
        </div>
    </body>";
