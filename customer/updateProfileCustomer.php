    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#health" role="tab" aria-controls="profile"
              aria-selected="false">Health</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#about" role="tab" aria-controls="contact"
              aria-selected="false">Security</a>
          </li>
        </ul>
        <?php include "updateProfileCustomerSuccess.php" ; ?>
          ...
          <div role="tabpanel" class="tab-pane fade active show" id="general">
            <div class="row justify-content-center">
              <div class="col-md-8  d-flex flex-column bd-highlight pt-5">
                      ...
                      $profileQuery = "SELECT * FROM SITE_USER WHERE pk_user_id = $user_id";
              ...
              <div class="image-container"><img src="../images/profile/<?php echo $user_profile_img?>" alt="<?=$user_profile_img?>"/></div>
